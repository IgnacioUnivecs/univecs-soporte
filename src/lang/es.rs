...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conexión a la red Univecs Soporte en progreso..."),
        ...
        ("install_tip", "Debido al Control de cuentas de usuario, es posible que Univecs Soporte no funcione correctamente como escritorio remoto. Para evitar este problema, haga clic en el botón de abajo para instalar Univecs Soporte a nivel de sistema."),
        ("Click to upgrade", "Clic para actualizar"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar su escritorio desde el exterior, debe otorgar permiso a Univecs Soporte de \"Accesibilidad\"."),
        ("config_screen", "Para controlar su escritorio desde el exterior, debe otorgar permiso a Univecs Soporte de \"Grabación de pantalla\"."),
        ...
        ("setup_server_tip", "Para una conexión más rápida, servidor conectado"),
        ...
        ("android_input_permission_tip1", "Para que un dispositivo remoto controle su dispositivo Android a través del ratón o toque, debe permitir que Univecs Soporte use el servicio de \"Accesibilidad\"."),
        ("android_input_permission_tip2", "Vaya a la página de configuración del sistema que se abrirá a continuación, busque y acceda a [Servicios instalados], active el servicio [Univecs Soporte Input]."),
        ...
        ("Turned off", "Apagado"),
        ("Language", "Idioma"),
        ("Keep RustDesk background service", "Dejar Univecs Soporte como Servicio en 2do plano"),
        ...
        ("Show Univecs Soporte", "Mostrar Univecs Soporte"),
        ("This PC", "Este PC"),
        ("or", "o"),
        ...
        ("config_input", "Para controlar el escritorio remoto con el teclado necesitas dar a Univecs Soporte permisos de \"Monitorización de entrada\"."),
        ("config_microphone", "Para poder hablar de forma remota necesitas darle a Univecs Soporte permisos de \"Grabar Audio\"."),
        ...
        ("verify_rustdesk_password_tip", "Verificar la contraseña de Univecs Soporte"),
        ...
        ("scam_text1", "Si estás al teléfono con alguien a quien NO conoces y en quien NO confías y te ha pedido que uses Univecs Soporte e inicies el servicio, no lo hagas y cuelga inmediatamente."),
        ...
        ("selinux_tip", "SELinux está activado en tu dispositivo, lo que puede hacer que Univecs Soporte no se ejecute correctamente como lado controlado."),
        ...
        ("powered_by_me", "Con tecnología de Univecs Soporte"),
        ...
        ("floating_window_tip", "Ayuda a mantener el servicio de Univecs Soporte de fondo"),
        ...
        ("About RustDesk", "Acerca de Univecs Soporte"),
        ...
        ("Accessible devices", ""),
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Por favor, actualiza el cliente Univecs Soporte a la versión {} o superior en el lado remoto"),
