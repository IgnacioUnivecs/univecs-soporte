...
class MyTheme {
  ...
  static const Color accent = Color(0xFF00ADD8);
  static const Color accent50 = Color(0x7700ADD8);
  static const Color accent80 = Color(0xAA00ADD8);
  static const Color canvasColor = Color(0xFF212121);
  static const Color border = Color(0xFFCCCCCC);
  static const Color idColor = Color(0xFF00ADD8);
  static const Color darkGray = Color.fromARGB(255, 148, 148, 148);
  static const Color cmIdColor = Color(0xFF21790B);
  static const Color dark = Colors.black87;
  static const Color button = Color(0xFF00ADD8);
  ...
  return FutureBuilder<ByteData>(
      ...
      builder: (BuildContext context, AsyncSnapshot<ByteData> snapshot) {
        if (snapshot.hasData) {
          ...
          return Container(
            constraints: BoxConstraints(maxWidth: 300, maxHeight: 90),
            child: image,
